...
public class CurrencyConversionController {
	...
	public CurrencyConversionBean convertCurrency(@PathVariable String from, @PathVariable String to,
		...
		LOGGER.info("Received Request to convert from {} {} to {}. Profit is {} ", quantity, from, to, conversionProfitPercentage);

		CurrencyConversionBean response = proxy.retrieveExchangeValue(from, to);

		BigDecimal conversionMultiple = BigDecimal.valueOf(100)
				.subtract(BigDecimal.valueOf(conversionProfitPercentage)).divide(BigDecimal.valueOf(100));
